...
async function runSettingsTest() {
    ...
    console.log("settings tests passed.", api);
}
...
async function runKeyringTest() {
    ...
    const initialAcc = await keyring.initKeys(
        [JSON.parse(testKeystore)],
        [0, 2]
    );
    expect(
        initialAcc[0][
...
async function runAccountTest() {
    ...
    const testAddr = "gvcqkts2R4tJFPHMZSuD6L8X6P5Twwt9qs6cWns8SvfBQit";
