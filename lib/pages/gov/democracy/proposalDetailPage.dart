...
class _ProposalDetailPageState extends State<ProposalDetailPage> {
  ...
  Future<void> _onSwitch() async {
    final dic = I18n.of(context).getDic(i18n_full_dic_bifrost, 'gov');
  ...
  Widget build(BuildContext context) {
    var dic = I18n.of(context).getDic(i18n_full_dic_bifrost, 'gov');
...
class ProposalSecondsList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Map dic = I18n.of(context).getDic(i18n_full_dic_bifrost, 'gov');
      ...
      GestureDetector(
        child: Row(
          children: <Widget>[
            ...
            Text(I18n.of(context).getDic(i18n_full_dic_bifrost, 'gov')['detail'])
          ],
        ),
        onTap: () {
          setState(() {
