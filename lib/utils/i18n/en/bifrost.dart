const Map<String, String> enDex = {
  ...
  'cross.warn': 'Warning',
  'cross.warn.network':
      'Exchanges do not currently support direct transfers of KSM to/from Bifrost. In order to successfully send KSM to an exchange address, it is required that you first complete an Cross-Chain-Transfer of the token(s) from Bifrost to Kusama.',
